...
# Load in image
def main():    
    img = scipy.misc.imread('../images/input/input_4.bmp')
    
    gray_img = scipy.misc.imread('../images/input/input_4.bmp', flatten='True')
    trimap = scipy.misc.imread('../images/input/mask_4.bmp', flatten='True')
